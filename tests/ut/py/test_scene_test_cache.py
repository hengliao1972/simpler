...
from simpler_setup.fdwic_build_config import FDWIC_SCHEDULER_MODE_IDS, fdwic_simt_builder_count
...
def _write_cross_core_e2e_clock_artifact(tmp_path: Path, profile: str, scheduler_mode: str) -> Path:
    ...
    for core_id in range(96):
        ...
        is_builder = (
            ...
            and not is_aic
            and lane == 1
            and block_id < fdwic_simt_builder_count(scheduler_mode, 32)
        )
        core = {
            "core_id": core_id,
    ...
    payload = {
        ...
        "aic_cores": 32,
        "aiv_cores": 64,
        "replay_cores": 96 - fdwic_simt_builder_count(scheduler_mode, 32),
