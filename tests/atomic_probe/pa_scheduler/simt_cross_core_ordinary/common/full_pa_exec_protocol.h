...
#ifndef PA_SCHEDULER_SIMT_CROSS_CORE_ORDINARY_FULL_PA_EXEC_PROTOCOL_H
#define PA_SCHEDULER_SIMT_CROSS_CORE_ORDINARY_FULL_PA_EXEC_PROTOCOL_H
...
#ifndef SIMT_CROSS_CORE_G0_TOKENS_PER_OWNER
#define SIMT_CROSS_CORE_G0_TOKENS_PER_OWNER 1U
#endif
constexpr uint32_t kTokensPerOwner = SIMT_CROSS_CORE_G0_TOKENS_PER_OWNER;
static_assert(
    kTokensPerOwner >= 1U && kTokensPerOwner <= 4U,
    "execution-token depth must remain in the validated 1..4 range"
);
...
#endif  // PA_SCHEDULER_SIMT_CROSS_CORE_ORDINARY_FULL_PA_EXEC_PROTOCOL_H
