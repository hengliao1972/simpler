...
bool CheckGenericFunctionStripedExecPlan(SchedulerState *state) {
    ...
    const std::vector<SharedHostExecPlanEntry> entries{
        {9, 20, cross_core_dag::ExecEngineClass::Aic},
        {4, 10, cross_core_dag::ExecEngineClass::Aic},
        {8, 3, cross_core_dag::ExecEngineClass::Aiv},
        {7, 20, cross_core_dag::ExecEngineClass::Aic},
        {6, 5, cross_core_dag::ExecEngineClass::Aiv},
        {2, 10, cross_core_dag::ExecEngineClass::Aic},
        {1, 3, cross_core_dag::ExecEngineClass::Aiv},
        {12, 10, cross_core_dag::ExecEngineClass::Aic},
    };
    std::string error;
    ...
    duplicate.push_back(
        {4, 30, cross_core_dag::ExecEngineClass::Aiv}
    );
    ...
    std::vector<SharedHostExecPlanEntry> invalid_engine{
        {0, 1, cross_core_dag::ExecEngineClass::Joint},
    };
...
int main() {
    ...
    for (uint32_t task_id = 0;
        ...
        if (executable &&
            engine == cross_core_dag::ExecEngineClass::Aic) {
            dispatch_plan_ok &=
                state->exec_dispatch
                    .aic_task_ids[expected_aic_tasks++] ==
                task_id;
        } else if (executable &&
                   engine == cross_core_dag::ExecEngineClass::Aiv) {
            dispatch_plan_ok &=
                state->exec_dispatch
