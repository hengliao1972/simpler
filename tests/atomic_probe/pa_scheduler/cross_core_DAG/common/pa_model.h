...
// cross_core_dag 的完整 PA 实现只复用同目录下的 portable
...
struct alignas(64) SchedulerState {
    ...
    cross_core_dag::SharedExecFatalControl exec_fatal;
    cross_core_dag::SharedExecDrainControl exec_drain;
    cross_core_dag::SharedExecCell exec_cells[kMaxTasks];
    cross_core_dag::ExecutionToken
        exec_tokens[kWorkers][cross_core_dag::kExecTokensPerWorker];
...
static_assert(
        offsetof(SchedulerState, exec_fatal) %
                cross_core_dag::kExecCacheLineBytes == 0 &&
        offsetof(SchedulerState, exec_drain) %
                cross_core_dag::kExecCacheLineBytes == 0 &&
        offsetof(SchedulerState, exec_cells) %
                cross_core_dag::kExecCacheLineBytes == 0 &&
