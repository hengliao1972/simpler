...
| A5 PA 功能/性能 | S5b 十轮 perf-clock 中位 27.496 ms；S6.1 为 9.078 ms；S6.2 为 7.304 ms；S6.3 将未 ready fanin 轮询移出集中式 fatal 读取后十轮中位 3.644 ms、full-swimlane 3.844 ms；最终目标为同口径不高于 1.0 ms |
