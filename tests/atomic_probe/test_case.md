...
|---:|---|---:|---:|---:|---:|---|
| 12 | flat CAS | 0/0 | 12.0 | 0.0 | 2311.1 | 恰好一个 winner |
| 12 | prefilter | 100/0 | 4.1 | 7.9 | 1309.7 | 恰好一个 winner |
| 12 | prefilter | 200/0 | 4.1 | 7.9 | 1303.7 | 恰好一个 winner |
| 12 | prefilter | 500/0 | 1.0 | 11.0 | 845.0 | 恰好一个 winner |
| 12 | 首选晚到接管 | 0/1000 | 12.0 | 0.0 | 2735.9 | 首选胜率 0，仍恰好一个 winner |

500 NOP 版本把返回型 CAS 数量从每轮 12 次降到 1 次，整轮中位 tick
减少约 `63.4%`。首选晚到对照证明其他 11 个候选仍能接管，并未改变“所有候选
