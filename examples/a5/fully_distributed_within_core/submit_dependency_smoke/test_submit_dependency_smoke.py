...
class TestSubmitDependencySmoke(SceneTestCase):
    ...
    CASES = [
        ...
        {
            "name": "A5OnboardBd1CompeteFirstFreshOutput",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4, "block_dim": 1},
        ...
        {
            "name": "A5OnboardBd24CompeteFirstFreshOutput",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4, "block_dim": 24},
            "params": {"n": 128, "mode": 32},
        ...
        {
            "name": "A5OnboardBd1CompeteFirstAllocOutput",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4, "block_dim": 1},
        ...
        {
            "name": "A5OnboardBd24CompeteFirstAllocOutput",
            "manual": True,
            "platforms": ["a5"],
            "config": {"aicpu_thread_num": 4, "block_dim": 24},
            "params": {"n": 128, "mode": 33},
